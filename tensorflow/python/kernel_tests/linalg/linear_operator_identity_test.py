...
class LinearOperatorIdentityTest(
  ...
  def _dtypes_to_test(self):
    # TODO (langmore) Test tf.float16 once tf.matrix_solve works in id:3465 gh:3466
    # 16bit.
...
class LinearOperatorScaledIdentityTest(
  ...
  @property
  def _dtypes_to_test(self):
    # TODO (langmore) Test tf.float16 once tf.matrix_solve works in id:3073 gh:3074
    # 16bit.
    return [dtypes.float32, dtypes.float64, dtypes.complex64, dtypes.complex128]
