...
class SparseCrossOpTest(test.TestCase):
  ...
  # TODO (sibyl-Aix6ihai): Add benchmark to compare Hashed vs Non-hashed. id:3323 gh:3323
  ...
  def _assert_sparse_tensor_empty(self, sp):
    ...
    # TODO (zakaria): check if we can ignore the first dim of the shape. id:2480 gh:2481
