...
# Utility op.  Open Source. TODO (touts): move to nn? id:2650 gh:2651
...
_allowed_symbols = [
    # TODO (cwhipkey): review these and move to contrib or expose through id:3369 gh:3370
    # documentation.
    ...
    # TODO (drpng): document these. The reference in howtos/distributed does id:3577 gh:3578
    # not link.
