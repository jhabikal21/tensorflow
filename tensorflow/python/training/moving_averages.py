...
# TODO (touts): switch to variables.Variable. id:3571 gh:3572
  ...
  def apply(self, var_list=None):
    ...
    Raises:
      ...
      ValueError: If the moving average of one of the variables is already
        being computed.
    """
    # TODO (touts): op_scope id:3310 gh:3311
    if var_list is None:
    ...
    for var in var_list:
      ...
      with ops.control_dependencies(None):
        if isinstance(var, variables.Variable):
          ...
          # NOTE (mrry): We only add `tf.Variable` objects to the id:3474 gh:3475
