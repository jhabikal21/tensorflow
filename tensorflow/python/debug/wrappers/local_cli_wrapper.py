...
class LocalCLIDebugWrapperSession(framework.BaseDebugWrapperSession):
  ...
  def _prep_debug_cli_for_run_end(self, debug_dump, tf_error, passed_filter):
    ...
    # TODO (cais): Reduce API surface area for aliases vis-a-vis tab id:3137 gh:3138
  ...
  def invoke_node_stepper(self,
    ...
    # TODO (cais): Perhaps some users will want the effect of the interactive id:2242 gh:2243
    ...
    # TODO (cais): Tie up register_tab_comp_context to a single alias to shorten id:2705 gh:2706
    # calls like this.
