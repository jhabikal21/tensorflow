...
# TODO (cais): Use nest.flatten once it handles nest Dicts correctly. id:2699 gh:2700
  ...
  def cont(self,
    ...
    Args:
      target: A single fetched Tensor or Op, or a name (str) representing the
        ...
        # TODO (cais): Support multiple fetches as in Session.run() interface. id:3174 gh:3175
