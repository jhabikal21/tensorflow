...
# TODO (cais): Tie these string constants in with C++? id:2234 gh:2235
...
class DebugTensorDatum(object):
  ...
  # TODO (cais): Add time unit suffix to timestamp and t0 (us). id:2693 gh:2694
  @property
  def timestamp(self):
...
class DebugDumpDir(object):
  ...
  def get_rel_timestamps(self,
    ...
    # TODO (cais): Figure out whether this should be relative to the global t0. id:3166 gh:3167
