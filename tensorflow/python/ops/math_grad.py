...
def _SumGrad(op, grad):
  ...
  input_shape = array_ops.shape(op.inputs[0])
  # TODO (apassos) remove this once device placement for eager ops makes more id:3173 gh:3174
  # sense.
...
def _IgammaGrad(op, grad):
  ...
  # TODO (ebrevdo): Perhaps add the derivative w.r.t. a id:3409 gh:3410
  a = op.inputs[0]
  x = op.inputs[1]
  ...
  # TODO (b/36815900): Mark None return values as NotImplemented id:2538 gh:2539
  return (None,
...
def _BetaincGrad(op, grad):
  ...
  # TODO (ebrevdo): Perhaps add the derivative w.r.t. a, b id:3231 gh:3232
  a, b, x = op.inputs
  ...
  # TODO (b/36815900): Mark None return values as NotImplemented id:3548 gh:3549
  return (None,  # da
          None,  # db
          array_ops.reshape(math_ops.reduce_sum(partial_x * grad, rx), sx))
...
def _ZetaGrad(op, grad):
  ...
  # TODO (tillahoffmann): Add derivative with respect to x id:3176 gh:3177
  x = op.inputs[0]
  q = op.inputs[1]
  # Broadcast gradients
  sx = array_ops.shape(x)
  ...
  with ops.control_dependencies([grad]):
    ...
    # TODO (b/36815900): Mark None return values as NotImplemented id:3412 gh:3413
    return (None,
...
def _PolygammaGrad(op, grad):
  ...
  # TODO (tillahoffmann): Add derivative with respect to n id:2540 gh:2541
  n = op.inputs[0]
  x = op.inputs[1]
  # Broadcast gradients
  ...
  with ops.control_dependencies([grad]):
    ...
    # TODO (b/36815900): Mark None return values as NotImplemented id:3233 gh:3234
    return (None,
            array_ops.reshape(math_ops.reduce_sum(partial_x * grad, rx), sx))
...
def _ComplexAbsGrad(op, grad):
  ...
  # TODO (b/27786104): The cast to complex could be removed once arithmetic id:3549 gh:3550
...
def _CumprodGrad(op, grad):
  ...
  # TODO This fails when x contains 0 and should be fixed id:3179 gh:3180
