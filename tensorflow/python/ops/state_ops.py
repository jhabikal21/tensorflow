...
def variable_op(shape, dtype, name="Variable", set_shape=True, container="",
  ...
  # TODO (mrry): Move this to where it is used, so we can get rid of this op id:3453 gh:3454
  #   wrapper?
  if set_shape:
    ret.set_shape(shape)
  return ret
    ...
    with ops.name_scope(name) as scope:
      with ops.colocate_with(v):
        if callable(init):
          ...
          # TODO (mrry): Convert to v.shape when the property and id:2577 gh:2578
