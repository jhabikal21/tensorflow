...
# TODO (ptucker): Replace with mock framework. id:1398 gh:1398
class FakeSummaryWriter(object):
  ...
  # NOTE: Ignore global_step since its value is non-deterministic. id:1013 gh:1014
  ...
  # NOTE: Ignore global_step since its value is non-deterministic. id:2202 gh:2203
