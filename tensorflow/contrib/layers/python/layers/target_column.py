...
# TODO (zakaria): Add logistic_regression_target id:656 gh:657
...
class _MultiClassTargetColumn(_TargetColumn):
  ...
  # TODO (zakaria): support multilabel. id:707 gh:708
  ...
  def get_eval_ops(self, features, logits, labels, metrics=None):
    ...
    if metrics is None:
      # TODO (b/29366811): This currently results in both an "accuracy" and an id:1160 gh:1161
...
# TODO (zakaria): use contrib losses. id:1000 gh:1001
