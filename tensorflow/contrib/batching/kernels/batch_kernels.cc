...
Status SplitGPU(OpKernelContext* context, const Tensor& input,
                const gtl::ArraySlice<int64>& sizes,
                std::vector<Tensor>* outputs) {
  // TODO (olston, apassos): Implement this. id:539 gh:540
...
#if GOOGLE_CUDA
// TODO (olston, apassos): Handle non-CPU cases. id:482 gh:483
...
#undef CASE
  ...
  // TODO (olston): Garbage-collect unused queues (perhaps simply remove empty id:504 gh:505
