...
def create_operator(matrix):
  ...
  # TODO (rmlarsen): Handle SparseTensor. id:1309 gh:1310
...
# TODO (rmlarsen): Measure if we should just call matmul. id:992 gh:993
def dot(x, y):
  return math_ops.reduce_sum(math_ops.conj(x) * y)


# TODO (rmlarsen): Implement matrix/vector norm op in C++ in core. id:2171 gh:2172
