...
# TODO (rmlarsen): Add implementation of symmetric Lanczos algorithm. id:1550 gh:1551
...
def lanczos_bidiag(operator,
  ...
  # TODO (rmlarsen): This is possibly the slowest implementation of id:1306 gh:1307
  ...
  def stopping_criterion(i, _):
    # TODO (rmlarsen): Stop if an invariant subspace is detected. id:991 gh:992
    return i < k
...
# TODO (rmlarsen): Implement C++ ops for handling bidiagonal matrices id:2169 gh:2170
