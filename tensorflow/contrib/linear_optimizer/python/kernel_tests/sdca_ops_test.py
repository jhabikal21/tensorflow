...
def make_variable_dict(max_age, max_gender):
  # TODO (sibyl-toe9oF2e):  Figure out how to derive max_age & max_gender from id:747 gh:748
  # examples_dict.
...
# TODO (sibyl-Mooth6ku): Add tests that exercise L1 and Shrinking. id:773 gh:774
# TODO (sibyl-vie3Poto): Refactor tests to avoid repetition of boilerplate code. id:1304 gh:1305
...
class SdcaWithLogisticLossTest(SdcaModelTest):
  ...
  # TODO (katsiaspis): add a test for the case when examples at the end of an id:1140 gh:1141
