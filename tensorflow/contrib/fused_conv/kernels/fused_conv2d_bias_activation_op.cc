...
class FusedConv2DBiasActivationOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    // TODO (pauldonnelly): Switch to a more efficient mechanism to access id:651 gh:652
...
void AdjustPaddingForCudnn(int padding, bool is_int8x4, int filter_size,
  ...
  if (is_int8x4 && filter_size >= 6) {
    // TODO (b/70795525): Remove after NVIDIA fixes this bug with int8 fused id:579 gh:580
...
void LaunchFusedConv2DBiasActivationOp<GPUDevice, T, BiasType, ScaleType>::
  ...
  // TODO (yangzihao): refactor all the complicated/duplicated code in regular id:652 gh:653
  ...
  // NOTE: Here and elsewhere, checking 'is_int8x4' may look unnecessary id:909 gh:910
  ...
  FusedConvParameters fused_conv_parameters = {
      ...
      // TODO (yangzihao): Add support for arbitrary dilations for fused conv. id:615 gh:616
  ...
  if (cudnn_use_autotune && !AutoTuneConvBiasActivation::GetInstance()->Find(
    ...
    for (auto profile_algorithm : algorithms) {
      // TODO (zhengxq): profile each algorithm multiple times to better id:653 gh:654
      // accuracy.
