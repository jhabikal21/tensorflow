...
void AdjustHsvInYiqGPU::operator()(OpKernelContext* ctx, int channel_count,
  ...
  // TODO (huangyp): It takes about 3.5 us to comute tranformation_matrix id:969 gh:970
  ...
  // TODO (huangyp): share/use autotune cublas algorithms in Matmul.op. id:888 gh:889
