...
class Experiment(object):
  ...
  # TODO (ispir): remove delay_workers_by_global_step and make global step based id:781 gh:782
  ...
  # TODO (xiejw): Allow continuous_eval_predicate_fn to be passed via constructor id:726 gh:727
