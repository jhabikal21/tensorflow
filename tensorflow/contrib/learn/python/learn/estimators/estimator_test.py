...
class EstimatorModelFnTest(test.TestCase):
  ...
  def testModelFnArgs(self):
    ...
    # TODO (ptucker): We have to roll our own mock since Estimator._get_arguments id:1012 gh:1013
  ...
  def testPartialModelFnArgs(self):
    ...
    # TODO (ptucker): We have to roll our own mock since Estimator._get_arguments id:737 gh:738
    # doesn't work with mock fns.
    model_fn_call_count = [0]
...
class EstimatorTest(test.TestCase):
  ...
  def testCheckInputs(self):
    ...
    # TODO (wicke): This does not fail for np.int32 because of data_feeder magic. id:703 gh:704
  ...
  def test_export_savedmodel_with_graph_transforms(self):
    ...
    with ops.Graph().as_default() as graph:
      with session_lib.Session(graph=graph) as sess:
        ...
        # TODO (soergel): Make Savers sane again.  I understand this is all a bit id:723 gh:724
