...
def get_input_alternatives(input_ops):
  ...
  # TODO (b/34253951): reinstate the "features" input_signature. id:1136 gh:1137
...
# TODO (b/67013778): Revisit this approach when corresponding changes to id:745 gh:746
