...
# TODO (xiejw): Refactor the learn_runner to make code reusable. id:1292 gh:1293
...
def _get_default_schedule(config):
  ...
  if config.task_type == run_config_lib.TaskType.MASTER:
    # TODO (rhaertel): handle the case where there is more than one master id:1128 gh:1130
