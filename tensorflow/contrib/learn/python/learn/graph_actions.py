...
def _train_internal(graph,
  ...
  with graph.as_default():
    ...
    # TODO (ipolosukhin): Replace all functionality of Supervisor id:748 gh:749
  ...
  with session:
    ...
    try:
      ...
      try:
        ...
        # TODO (wicke): This should be handled by Supervisor id:1216 gh:1217
...
def evaluate(graph,
  ...
  with session:
    if not initialized:
      ...
      # TODO (ipolosukhin): This should be failing, but old code relies on that. id:1045 gh:1046
    ...
    eval_results = None
    # TODO (amodei): Fix this to run through the eval set exactly once. id:783 gh:783
    step = 0
    eval_step = None
    feed_dict = None
    ...
    try:
      try:
        while (max_steps is None) or (step < max_steps):
          ...
          # TODO (wicke): We should assert that the global step hasn't changed. id:727 gh:728
