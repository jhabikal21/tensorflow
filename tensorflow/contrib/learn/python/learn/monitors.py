...
# TODO (ptucker): Split each monitor class into a separate file. id:798 gh:799
# TODO (ptucker): Fail if epoch or step does not monotonically increase? id:740 gh:741
class BaseMonitor(object):
  ...
  def set_estimator(self, estimator):
    ...
    # TODO (mdan): This should fail if called twice with the same estimator. id:765 gh:766
...
class EveryN(BaseMonitor):
  ...
  """
  # TODO (ipolosukhin): Add also every n seconds. id:1296 gh:1297
...
# TODO (ptucker): Rename to LoggingTensor since it's not writing to stdout. id:1132 gh:1133
...
class SummarySaver(EveryN):
  ...
  def __init__(self,
    ...
    """
    # TODO (ipolosukhin): Implement every N seconds. id:800 gh:801
    ...
    # TODO (mdan): Throw an error if output_dir and summary_writer are None. id:742 gh:743

  def set_estimator(self, estimator):
    super(SummarySaver, self).set_estimator(estimator)
    # TODO (mdan): This line looks redundant. id:767 gh:768
...
class ValidationMonitor(EveryN):
  ...
  def __init__(self, x=None, y=None, input_fn=None, batch_size=None,
    ...
    super(ValidationMonitor, self).__init__(every_n_steps=every_n_steps,
                                            first_n_steps=-1)
    # TODO (mdan): Checks like this are already done by evaluate. id:1298 gh:1299
  ...
  def every_n_step_end(self, step, outputs):
    ...
    # TODO (mdan): The use of step below is probably misleading. id:1134 gh:1135
...
# TODO (ptucker): This really reads any tensor, not just vars, and requires the id:802 gh:803
...
class GraphDump(BaseMonitor):
  ...
  # TODO (ptucker): Handle keys that are in one but not the other. id:743 gh:744
