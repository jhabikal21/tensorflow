...
class LayerNormBasicLSTMCellTest(test.TestCase):
  ...
  # NOTE: all the values in the current test case have been calculated. id:929 gh:930
...
class CompiledWrapperTest(test.TestCase):
  ...
  def testMultiRNNCellWithLSTMCellAndXLA(self):
    # TODO (b/34735319): Don't run this test if XLA is not available. id:1544 gh:1545
    batch_size = 16
    num_units = 32
    input_depth = 12
    num_layers = 2
