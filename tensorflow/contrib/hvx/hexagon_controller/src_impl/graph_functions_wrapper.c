...
// TODO (satok): allocate dynamically id:678 gh:679
...
static const char* ConvertGraphInfoIdToName(unsigned int id) {
  // TODO (satok): implement id:614 gh:615
  return "?";
}

static const char* ConvertGraphInfoIdToOpName(unsigned int id) {
  // TODO (satok): implement id:674 gh:675
  return "?";
}
...
uint32_t hexagon_controller_InstantiateGraph() {
  ...
  // TODO (satok): make this as argument id:966 gh:967
