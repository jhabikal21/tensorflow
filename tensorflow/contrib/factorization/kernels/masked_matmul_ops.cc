...
class MaskedMatmulOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    // TODO (walidk): improve performance in the case adj_a and not adj_b id:584 gh:585
    // TODO (walidk): benchmark smaller inputs, and potentially skip the sort id:620 gh:621
