...
// TODO (agarwal,rmlarsen): Add security checks to the code. id:556 gh:557
...
// TODO (ataei): Consider using RowMajor maps. id:627 gh:628
typedef Eigen::Map<
...
class WALSComputePartialLhsAndRhsOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    // TODO (rmlarsen): In principle, we should be using the SparseTensor class id:887 gh:888
    ...
    // mutex.
    //
    // TODO (jpoulson): Simplify after the thread rank can be queried id:586 gh:587
    ...
    auto work = [&](const Shard& shard) {
      ...
      //
      // TODO (jpoulson): Switch to try_emplace once C++17 is supported id:624 gh:625
      map_mutex.lock();
