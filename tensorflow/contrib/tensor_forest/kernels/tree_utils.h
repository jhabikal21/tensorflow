...
// TODO (gilberth): Put these in protos so they can be shared by C++ and python. id:1003 gh:1004
...
int32 GetNumSparseFeatures(const T1& indices, int32 input_index,
  ...
  // TODO (gilberth): Consider using std::lower_bound, std::upper_bound id:2183 gh:2184
