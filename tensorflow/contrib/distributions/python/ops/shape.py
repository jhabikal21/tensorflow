...
class _DistributionShape(object):
  ...
  # TODO (jvdillon): Make remove expand_batch_dim and make expand_batch_dim=False id:565 gh:567
  ...
  # TODO (jvdillon): Make remove expand_batch_dim and make expand_batch_dim=False id:596 gh:597
  # the default behavior.
