...
# TODO (sibyl-vie3Poto,felixyu): add an option to control whether the parameters in the id:891 gh:892
...
class RandomFourierFeatureMapper(dkm.DenseKernelMapper):
  ...
  def __init__(self, input_dim, output_dim, stddev=1.0, seed=1, name=None):
    ...
    """
    # TODO (sibyl-vie3Poto): Maybe infer input_dim and/or output_dim (if not explicitly id:686 gh:687
