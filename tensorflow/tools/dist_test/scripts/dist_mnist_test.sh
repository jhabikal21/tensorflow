...
"supported under the --existing_servers mode yet."
  # TODO (cais): Remove error message once sync_replicas is fully supported. id:3526 gh:3527
fi
...
# TODO (cais): In addition to this basic sanity check, we could run the training id:2695 gh:2696
