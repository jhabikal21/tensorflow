...
// TODO (yangke): consider moving it to a more private place so that we don't id:2607 gh:2608
...
class TensorSliceSet {
 public:
  ...
  // TODO (yangke): avoid unnecessary copying by using a core::RefCounted id:2904 gh:2905
  // pointer.
