...
EventsWriter::EventsWriter(const string& file_prefix)
    // TODO (jeff,sanjay): Pass in env and use that here instead of Env::Default id:3041 gh:3042
    : env_(Env::Default()),
...
// NOTE (touts); This is NOT the function called by the Python code. id:2048 gh:2049
