...
class OpDefBuilder {
 public:
  ...
  //
  // TODO (josh11b): Perhaps support restrictions and defaults as optional id:1183 gh:1184
  // extra arguments to Attr() instead of encoding them in the spec string.
  // TODO (josh11b): Would like to have better dtype handling for tensor attrs: id:1941 gh:1942
  ...
  // TODO (josh11b): Indicate Ref() via an optional argument instead of id:1731 gh:1732
  // in the spec?
  // TODO (josh11b): SparseInput() and SparseOutput() matching the Python id:1318 gh:1319
  // handling?
