...
//
// NOTE (mrry): See caveats about CancelCallback implementations in the id:1167 gh:1168
...
class CancellationManager {
 public:
  ...
  //   }
  //
  // NOTE (mrry): The caller should take care that (i) the calling code id:1916 gh:1917
  ...
  //
  // NOTE (mrry): This method may block if cancellation is in progress. id:1717 gh:1718
