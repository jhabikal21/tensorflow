...
bool IsConstantFoldable(
  ...
  // TODO (yuanbyu): For now disable these session handle operations. id:2331 gh:2332
  ...
  // TODO (phawkins): allow constant-folding for functions; functions may id:1053 gh:1054
...
bool ReplaceTensorWithConstant(Graph* graph, Device* partition_device,
  ...
  // TODO (keveman): Consider adding a new constant op that has a kernel id:1760 gh:1761
