...
void EventMgr::ThenDeleteTensors(perftools::gputools::Stream* stream,
  ...
  mutex_lock l(mu_);
  // TODO (jeff): We currently keep one accumulated_tensors_ object. id:1082 gh:1083
...
//
// NOTE: If all events are on the same stream, no later event will id:2357 gh:2358
