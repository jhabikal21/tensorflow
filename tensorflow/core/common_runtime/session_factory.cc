...
Status SessionFactory::GetFactory(const SessionOptions& options,
  ...
  if (candidate_factories.size() == 1) {
    *out_factory = candidate_factories[0].second;
    ...
    // NOTE (mrry): This implementation assumes that the domains (in id:1830 gh:1831
    ...
    // TODO (mrry): Consider providing a system-default fallback option id:1658 gh:1659
    // in this case.
    std::vector<string> factory_types;
