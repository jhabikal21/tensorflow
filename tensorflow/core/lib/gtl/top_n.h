...
// time is linear in p.
//
// NOTE (zhifengc): There is a way to do this in O(min(n, p)) storage and O(p) id:1920 gh:1921
...
//
// NOTE (zhifengc): This class should be redesigned to avoid reallocating a id:2422 gh:2423
