...
class optional : private internal_optional::optional_data<T>,
 ...
 public:
  ...
  // TODO (b/34201852): Add std::is_constructible<T, Args&&...> SFINAE. id:1918 gh:1919
  template <typename... Args>
...
// NOTE: we assume is_swappable is always true. There will be a compiling error id:2418 gh:2419
...
// NOTE: make_optional cannot be constexpr in C++11 because the copy/move id:2635 gh:2636
