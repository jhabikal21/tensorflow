...
class WorkerCacheInterface {
 public:
  ...
  // TODO (mrry): rename this to GetOrCreateWorker() or something that id:2455 gh:2456
  ...
  //
  // TODO (jeff,sanjay): Consider moving target into WorkerInterface. id:1155 gh:1156
  // TODO (jeff,sanjay): Unify all worker-cache impls and factor out a id:1898 gh:1899
