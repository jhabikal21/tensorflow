...
// NOTE: This API is a work in progress and will likely be changing frequently. id:1975 gh:1976
//
...
// TODO (andydavis) Add symbolic gradient support for general graphs (the current id:1785 gh:1786
