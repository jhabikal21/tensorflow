...
class CostModel {
 public:
  ...
  // NOTE (tucker): Maybe this should move to a subclass of CostModel. id:1973 gh:1974
 ...
 private:
  ...
  struct MemUsage {
    ...
    // TODO (yuefengz): temp_memory_size is not being used, remove it. id:1782 gh:1783
