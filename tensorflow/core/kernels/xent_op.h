...
struct XentEigenImpl {
  static void Compute(const Device& d, typename TTypes<T>::ConstMatrix logits,
                      ...
                      typename TTypes<T>::Vec loss,
                      typename TTypes<T>::Matrix backprop) {
    // NOTE (touts): This duplicates some of the computations in softmax_op id:2939 gh:2940
...
// the resulting value to all classes.
    ...
    // NOTE (keveman): Eigen on GPU dispatches to an optimized implementation id:1911 gh:1912
