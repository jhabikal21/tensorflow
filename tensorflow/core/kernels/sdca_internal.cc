...
// TODO (sibyl-Aix6ihai): Refactor/shorten this function. id:2299 gh:2300
...
Status Examples::CreateSparseFeatureRepresentation(
      ...
      for (int example_id = 0; example_id < num_examples; ++example_id) {
        ...
        if (start_id < example_indices.size() &&
          ...
          if (end_id - start_id > 0) {
            // TODO (sibyl-Aix6ihai): Write this efficiently using vectorized id:2412 gh:2413
  ...
  // TODO (sibyl-Aix6ihai): Tune this as a function of dataset size. id:1659 gh:1660
...
Status Examples::CreateDenseFeatureRepresentation(
  ...
  // TODO (sibyl-Aix6ihai): Tune this as a function of dataset size. id:2884 gh:2885
  const int64 kCostPerUnit = num_examples;
...
void Examples::ComputeSquaredNormPerExample(
  ...
  // TODO (sibyl-Aix6ihai): Compute the cost optimally. id:1786 gh:1787
