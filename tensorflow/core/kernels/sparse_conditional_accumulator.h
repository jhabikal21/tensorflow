...
class SparseConditionalAccumulator
 ...
 protected:
  ...
  void AllocateAndAssignToAccumGradFunction(
    ...
    // TODO (b/32704451): Don't just ignore the ::tensorflow::Status object! id:1681 gh:1682
  ...
  bool GetAndValidateTensorInputForApplyGrad(
      ...
      EXCLUSIVE_LOCKS_REQUIRED(this->mu_) {
    // TODO (xinghao, jmchen): The roundabout way of getting attr from id:2901 gh:2902
