...
class Conv3DOp : public BinaryOp<T> {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    // NOTE: The ordering of the spatial dimensions is arbitrary, but has to be id:2130 gh:2131
...
// TODO (mjanusz): Share logic with 2d implementation as much as possible. id:1935 gh:1936
template <typename T>
struct LaunchConvOp<GPUDevice, T> {
  static void launch(OpKernelContext* ctx, bool cudnn_use_autotune,
    ...
    // NOTE: This only works in NHWC. id:1459 gh:1460
    ...
    if (padding == Padding::SAME) {
      ...
      // TODO (mjanusz): Consider making this optional? This would save some id:2621 gh:2622
    ...
    ConvParameters conv_parameters = {
        ...
        // TODO (yangzihao): Send in arbitrary dilation rates after the dilated id:1368 gh:1369
        // conv is supported.
        /*dilation=*/{{1, 1, 1}},
    ...
    if (cudnn_use_autotune && !AutoTuneConv3d::GetInstance()->Find(
      ...
      for (auto profile_algorithm : algorithms) {
        // TODO (zhengxq): profile each algorithm multiple times to better id:2133 gh:2134
        // accuracy.
