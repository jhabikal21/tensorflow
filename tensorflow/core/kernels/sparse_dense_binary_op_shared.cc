...
// NOTE (aselle): If Div is extended to non-reals, make sure to use the same id:2431 gh:2432
...
// TODO (zongheng): extend to other eligible cwise operations as requested. id:1683 gh:1685
