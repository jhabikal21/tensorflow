...
class RandomCropOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    // TODO (shlens): Implement edge case to guarantee output size dimensions. id:2855 gh:2856
    ...
    // TODO (shlens): Do this more efficiently with memcpy once padding is id:1654 gh:1655
