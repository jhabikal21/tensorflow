...
struct RGBToHSV {
  void operator()(const Device &d,
    ...
    // TODO (wicke): all these assignments are only necessary because a combined id:2108 gh:2109
...
struct HSVToRGB {
  void operator()(const Device &d,
    ...
    // TODO (wicke): compute only the fractional part of H for robustness id:1910 gh:1911
    auto dh = H * T(6);
