...
// TODO (shengx): The helper classes/methods are changed to support multiclass id:2301 gh:2302
...
void DoCompute(const ComputeOptions& options, OpKernelContext* const context) {
  ...
  // TODO (sibyl-Aix6ihai): Tune this properly based on sparsity of the data, id:2414 gh:2415
...
class SdcaOptimizer : public OpKernel {
 ...
 private:
  // TODO (sibyl-Aix6ihai): We could use the type-constraint on loss_type, and id:1670 gh:1671
 ...
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    if (weights_inputs.size() > 0) {
      ...
      // TODO (sibyl-Aix6ihai): Tune this value. id:2887 gh:2888
