...
public class StylizeActivity extends CameraActivity implements OnImageAvailableListener {
          ...
          new OnClickListener() {
            ...
            public void onClick(final View v) {
              if (textureCopyBitmap != null) {
                // TODO (andrewharp): Save as jpeg with guaranteed unique filename. id:2640 gh:2641
  ...
  private void renderDebug(final Canvas canvas) {
    // TODO (andrewharp): move result display to its own View instead of using debug overlay. id:2946 gh:2947
