...
// TODO (andrewharp): Make this a cast to uint32_t if/when we go unsigned for id:2619 gh:2620
// operations.
#define ZERO 0
...
// TODO (andrewharp): Make explicit which operations support negative numbers or id:2926 gh:2927
...
class Image {
 public:
  ...
  // purposes.
  // TODO (andrewharp): check in interpolation follow-up change. id:1852 gh:1853
  ...
  // TODO (andrewharp): Generalize this for any size filter. id:3076 gh:3077
  template <typename U>
  ...
  // TODO (andrewharp): make these only accessible by other Images. id:2083 gh:2084
 ...
 private:
  ...
  // TODO (andrewharp): Make sure that stride is honored in all code. id:2623 gh:2624
  const int stride_;
