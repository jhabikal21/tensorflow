...
bool OpticalFlow::FindFlowAtPoint_LK(const Image<uint8_t>& img_I,
  ...
  for (int iteration = 0; iteration < kNumIterations; ++iteration) {
    ...
    // TODO (andrewharp): Probably better to completely detect and handle the id:1864 gh:1865
...
bool OpticalFlow::FindFlowAtPoint_ESM(
  ...
  // TODO (rspring): try out the IntegerPatchAlign() method once id:3082 gh:3083
