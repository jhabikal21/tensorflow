...
// NOTE: no native object detectors are currently provided or used by the code id:2629 gh:2630
...
class Detection {
 public:
  ...
  // TODO (andrewharp): add accessors to update these instead. id:2933 gh:2934
