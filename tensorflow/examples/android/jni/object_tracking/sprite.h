...
class Sprite {
 ...
 private:
  ...
  // TODO (andrewharp): Allow sprites to have their textures reloaded. id:2090 gh:2091
  void LoadTexture(const Image<uint8_t>& texture_source,
    ...
    // memory.
    // TODO (andrewharp): Figure out if data can be pulled directly from the id:2637 gh:2638
