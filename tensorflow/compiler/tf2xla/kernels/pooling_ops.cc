...
static xla::ComputationDataHandle AvgPoolDivideByCount(
  ...
  if (padding == xla::Padding::kValid) {
    ...
    // TODO (phawkins): use a less brute-force way to compute this. Only id:207 gh:208
...
class MaxPoolGradOp : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    // TODO (phawkins): The XLA version doesn't need tensor_out. Investigate id:208 gh:209
