...
Status GpuLayoutAssignment::AddBackendConstraints(
  ...
  for (auto* instruction : constraints->computation()->instructions()) {
    ...
    //
    // TODO (b/29399649): Be more flexible about handling layouts of cuDNN calls. id:373 gh:374
    if (ImplementedAsDnnConvolution(*instruction)) {
      ...
      // TODO (b/29399649): Be more flexible about handling layouts of cuDNN id:343 gh:344
