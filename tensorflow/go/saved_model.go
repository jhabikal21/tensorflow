...
// TODO (jhseu): Add and document metagraphdef when we pregenerate protobufs. id:2126 gh:2127
...
func LoadSavedModel(exportDir string, tags []string, options *SessionOptions) (*SavedModel, error) {
	...
	graph := NewGraph()
	// TODO (jhseu): Add support for run_options and meta_graph_def. id:2646 gh:2647
