...
class CUDADriver {
 public:
  ...
  //
  // TODO (leary) verify an error will be returned if the location wasn't id:3382 gh:3383
  ...
  // TODO (leary) describe the structure of kernel_params and extra in a readable id:3583 gh:3584
  // way.
  ...
  // TODO (leary) the documentation doesn't say what kind of disasters happen id:3334 gh:3335
  ...
  //
  // TODO (leary) if a pathological thread enqueues operations onto the stream id:3499 gh:3500
