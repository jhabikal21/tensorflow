...
class Stream {
 public:
  ...
  // TODO (leary) If work is added to the stream that is being depended upon, id:3355 gh:3356
  ...
  // TODO (leary) add double-precision version of this interface. id:3513 gh:3514
  ...
  // values. TODO (leary) seeding API/description id:2681 gh:2682
  //
